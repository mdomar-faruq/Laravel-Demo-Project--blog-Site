	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<hr>
				<form  method="POST" action="{{ route('AuthorProfilePost') }}">    @csrf
					@if(session('success'))
						{{session('success')}}
					@endif
					@if($errors->any())
				...
				<div class="card-body">
					...
					<div class="col-md-8 ">
					    ...
					    <label for="exampleInputEmail12">New passwpord Confirmation</label>
					    <input type="password" name="New_password_confirmation" class="form-control" id="exampleInputEmail12">
