        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                  <li>
                      <h5><i class="fa fa-user fa-fw"></i> User </h5>
                  </li>

                    <li>
                        <a class="{{Route::currentRouteName() == 'UserDashboard' ? 'active':''}}waves-effect waves-dark" href="{{route('UserDashboard')}}"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="{{route('UserProfile')}}" class="{{Route::currentRouteName() == 'UserProfile' ? 'active':''}}waves-effect waves-dark"><i class="fa fa-user fa-fw"></i>Profile</a>
                    </li>
                    <li>
                        <a href="{{route('UserComments')}}" class="waves-effect waves-dark"><i class="fa fa-comments-o"></i>Comments</a>
                    </li>
